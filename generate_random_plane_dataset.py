...
from src.environment.random_plane_trajectory import (
    RandomPlaneTrajectory,
    random_plane_trajectory_factory
)
...
if __name__ == '__main__':
    ...
    generate_dataset(SyntheticVideoDatasetConfig(
        trajectory_factory=partial(random_plane_trajectory_factory, RandomPlaneTrajectory(
